                ...
                <div class="flex flex-col justify-start md:space-y-12 space-y-8 transition-colors duration-200">
                    ...
                    >
                        ...
                        <div class="flex flex-col items-start space-y-1">
                            <p class="tracking-wide md:text-2xl text-xl">"neurodynamica"</p>
                                <p class="text-start md:w-full w-48">"dynamics of my thoughts and notes"</p>
                        </div>
                    </a>
                    <a
